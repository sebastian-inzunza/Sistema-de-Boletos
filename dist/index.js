    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _req$body = req.body, username = _req$body.username, password = _req$body.password; // Realiza la validación de las credenciales del usuario
          if (username === "admin" && password === "883ey$3*TldX33AKsQGksa4v%") {
            // Credenciales válidas, genera un token JWT
            token = _jsonwebtoken["default"].sign({
              username: username
            }, secretKey); // Envía el token como respuesta
            res.json({
              token: token
            });
          } else {
...
_app["default"].get("/alta", authenticateJWT, function (req, res) {
  res.sendFile(__dirname + "../src/public/alta.html");
});
_app["default"].post("/logout", function (req, res) {
...
_app["default"].get("/data", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _Comprados["default"].find();
        case 3:
          data = _context2.sent;
...
_app["default"].get("/verificados", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _Verificados["default"].find();
        case 3:
          data = _context3.sent;
          // Renderizar el archivo "alta.html" y pasar los datos a la plantilla
          res.json(data);
